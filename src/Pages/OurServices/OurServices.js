...
import financing from "../../Assets/images/calcultor.png"
import man1 from "../../Assets/images/business-1.jpg"
import man2 from "../../Assets/images/business-2.jpg"
import man3 from "../../Assets/images/business.jpg"
import man4 from "../../Assets/images/business-4.jpg"
import Aos from 'aos';
...
const OurServices = () => {
    ...
    return (
        <section id="service" >
        <div  style={{backgroundColor:"#f8f9fa",paddingBottom:"100px"}} className="row  justify-content-center  d-flex flex-sm-column flex-md-row
    service-container">
        ...
        <h1 className="pb-5 text-center">
            ...
            <div data-aos={"zoom-in-down"} style={{ backgroundColor: "#f8f9fa" }}  className="col-md-10  p-0 ">
